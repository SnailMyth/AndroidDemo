...
public class ParticleView extends View {
  ...
  public void boom(final View view) {
    ...
    if (view.getVisibility() != View.VISIBLE || view.getAlpha() == 0 || (mParticleAnimator != null
        && mParticleAnimator.isRunning())) {
      return;
    }
    view.post(new Runnable() {
      ...
      public void run() {
        ...
        Rect rect = new Rect(location[0], location[1], location[0] + view.getMeasuredWidth(),
