package com.example.testdemo.view.wavetext;
...
import com.example.testdemo.utils.ScreenUtils;
...
public class Wave extends View {
  ...
  private int    mWidth   = SizeUtil.dip2px(getContext(), 50);
  private int    mHeight  = SizeUtil.dip2px(getContext(), 50);
  private Path   path;
  private float  currentPercent;
  private int    color;
  private String text     = "贴";
  private int    textSize = SizeUtil.sp2px(getContext(), 25);
